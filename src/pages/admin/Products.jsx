...
const AdminProducts = () => {
  ...
  const removeCustomizationOption = (index) => {
    const updated = formData.customization_options.filter((_, i) => i !== index);
    setFormData({ ...formData, customization_options: updated });
  };
          ...
          <div className="bg-white rounded-2xl max-w-2xl w-full max-h-[90vh] overflow-y-auto">
            ...
            <div className="p-6 space-y-4">
              ...
              <div className="flex items-center gap-3">
                ...
                >
                  {formData.is_active ? <><Eye size={18} /> Ativo</> : <><EyeOff size={18} /> Inativo</>}
                </button>
              </div>
              ...
              <div>
                <div className="flex items-center justify-between mb-3">
                  <label className="block text-sm font-medium text-gray-700">Opções de Personalização</label>
                  <button
                    type="button"
                      ...
                      <div className="grid grid-cols-3 gap-3">
                        ...
                        <label className="flex items-center gap-2 cursor-pointer">
                          <input
                            ...
                            onChange={(e) => updateCustomizationOption(index, 'allows_image', e.target.checked)}
